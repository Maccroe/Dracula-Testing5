  ...
  async execute(message, client) {
    ...
    return message.reply({
      ...
      embeds: [
        ...
        .setDescription("Hey,you called me? I'm Drago! Nice to meet you.Type `/` and click on my logo to see all my commands.\n\nUse `/help` to get an overview about the commands.Setup the server by going to the [Dashboard](https://Dracula-Testing.hiby.repl.co)\n\n*This message will be deleted in `10 seconds!`*")
